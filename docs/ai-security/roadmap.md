...
## 1. [OWASP LLM Top 10 & Prompt Attacks](./owasp-llm-top-10-and-prompt-attacks.md)
...
## 2. [Model & Data Attacks](./model-and-data-attacks.md)
...
Next: [AI Safety & Alignment](../ai-safety/roadmap.md) — a related but distinct discipline: security is about defending against adversaries, safety is about a well-intentioned system still behaving badly.
