...
- **Feature engineering**: turning stored data into the actual model inputs (see [ML Workflow Fundamentals](../machine-learning/ml-workflow-fundamentals.md)).

## Databases

- **PostgreSQL / MySQL**: the standard relational stores for structured application and pipeline metadata (see [Databases — Relational](../databases/relational/overview.md)).
...
Next: [Experiment Tracking](./experiment-tracking.md) — once your data is versioned and trustworthy, tracking what you actually did with it.
