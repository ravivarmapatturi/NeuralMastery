...
- **Amazon ECR**: AWS's private registry, the default choice when the rest of the stack is on AWS (see [Cloud Computing for ML](./cloud-computing.md)).
...
Next: [APIs & Model Serving](./model-serving.md) — a containerized model is only useful once something exposes it to the outside world as an API.
