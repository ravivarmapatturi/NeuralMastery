...
Next: [Observability](./observability.md) — the general logging/metrics/tracing infrastructure that drift detection and everything else above is built on top of.
