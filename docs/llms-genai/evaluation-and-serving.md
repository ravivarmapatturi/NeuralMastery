...
LLMs & GenAI core content complete. Continue to: [Multimodal & Generative Models](./multimodal-generative-models.md) for the vision/diffusion side, or on to [Agents](../agents/roadmap.md) for how LLMs take action.
