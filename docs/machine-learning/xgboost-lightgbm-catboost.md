...
This completes the tree-based model family: [Decision Tree](./decision-tree.md) → [Random Forest & Extra Trees](./random-forest.md) → [Boosting](./boosting.md) → XGBoost/LightGBM/CatBoost. Next: [Support Vector Machines](./support-vector-machines.md) and the other margin-based and instance-based classifiers.
