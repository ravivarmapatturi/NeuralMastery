...
Next: [ICA, t-SNE & UMAP](./ica-tsne-umap.md) — separating mixed signals, and the nonlinear methods built specifically for visualizing high-dimensional data like embeddings.
