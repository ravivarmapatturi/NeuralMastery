...
Next: [Software Engineering Practice](./software-engineering-practices.md) — turning this tooling fluency into code that survives contact with a team and a production system.
