...
export const Y_DOMAIN = [0, 110];
export const W_DOMAIN = [-2, 16];
export const B_DOMAIN = [0, 100];
...
export const OUTLIER_POINT = { x: 9, y: 28 };
...
export function computeStats(points, w, b) {
  let sumSq = 0;
  let sumErr = 0;
  let sumErrX = 0;
  points.forEach((p) => {
...
export function gradientStep(points, w, b, lr) {
